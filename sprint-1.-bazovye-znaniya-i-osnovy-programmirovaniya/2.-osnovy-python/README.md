...
{% hint style="warning" %}
Ссылка на видеолекцию по данной теме - [https://youtu.be/m6Bf6ZTkzQQ](https://youtu.be/m6Bf6ZTkzQQ)
{% endhint %}
...
* **M**ultiplication \(умножение\) и **D**ivision \(деление\) имеют одинаковый приоритет. Такой же приоритет имеет операция деления по модулю \(**M**odulo\);
...
![](../../.gitbook/assets/python-anaconda-prompt-anaconda3-python-2-1-.gif)
...
![](../../.gitbook/assets/spyder-python-3.8-spyder-python-3.8-.gif)
...
![](../../.gitbook/assets/spyder-python-3.8-spyder-python-3.8-1-2-.gif)
